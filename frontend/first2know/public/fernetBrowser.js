  ...
  return (function e(t, n, r) {
  ...
  })(
    {
      1: [
        function (require, module, exports) {
          ...
          var fernet = function fernet(opts) {
            ...
            this.createHmac = function createHmac(
              signingKey,
              time,
              iv,
              cipherText
        ...
        },
        {
          "./lib/secret": 2,
          "./lib/token": 3,
          __browserify_Buffer: 16,
          crypto: 11,
          "crypto-js/aes": 18,
          "crypto-js/core": 20,
          "crypto-js/enc-base64": 21,
          "crypto-js/enc-hex": 22,
          "crypto-js/enc-latin1": 23,
          "crypto-js/enc-utf8": 24,
          "crypto-js/hmac-sha256": 26,
          "urlsafe-base64": 31,
        },
      ],
      2: [
          ...
          module = module.exports = function (parent) {
            ...
            Token.prototype = {
              ...
              encode: function encodeToken(message) {
                ...
                this.cipherText = fernet.encryptMessage(
                  this.message,
                  this.secret.encryptionKey,
                  this.iv
                );
                this.token = fernet.createToken(
              ...
              decode: function decodeToken(token) {
                ...
                var timeInt = fernet.parseHex(
                  tokenString.slice(versionOffset, timeOffset)
                );

                this.version = fernet.parseHex(
                  tokenString.slice(0, versionOffset)
                );
                ...
                var decodedHmac = fernet.createHmac(
                  this.secret.signingKey,
                  fernet.timeBytes(this.time),
                  this.iv,
                  this.cipherText
                );
                ...
                for (var i = 0; i < 64; i++) {
                  accum +=
                    decodedHmacHex.charCodeAt(i) ^ this.hmacHex.charCodeAt(i);
                }
                if (accum != 0) throw new Error("Invalid Token: HMAC");

                this.message = fernet.decryptMessage(
                  this.cipherText,
                  this.secret.encryptionKey,
                  this.iv
                );
      ...
      list should be an Array."
        ...
        { "./buffer_ieee754": 7, assert: 4, "base64-js": 9 },
      ],
      9: [
        function (require, module, exports) {
          (function (exports) {
      ...
      11: [
        ...
        { "./md5": 12, "./rng": 13, "./sha": 14, "./sha256": 15, buffer: 8 },
      ],
      12: [
        function (require, module, exports) {
          /*
                ...
                function (require, module, exports) {
                  ...
                  SlowBuffer.prototype.utf8Slice = function () {
                    ...
                    while (i < bytes.length) {
                      if (bytes[i] <= 0x7f) {
                        res +=
                          decodeUtf8Char(tmp) + String.fromCharCode(bytes[i]);
                        tmp = "";
                      } else tmp += "%" + bytes[i].toString(16);
      ...
      list should be an Array."
                  ...
                  function readUInt32(buffer, offset, isBigEndian, noAssert) {
                    ...
                    if (isBigEndian) {
                      ...
                      val =
                        val +
                        ((buffer.parent[buffer.offset + offset] << 24) >>> 0);
                    } else {
                      if (offset + 2 < buffer.length)
                      ...
                      if (offset + 3 < buffer.length)
                        val =
                          val +
                          ((buffer.parent[buffer.offset + offset + 3] << 24) >>>
                            0);
                    }
                  ...
                  Buffer.prototype.readInt8 = function (offset, noAssert) {
                    ...
                    return (
                      (0xff - buffer.parent[buffer.offset + offset] + 1) * -1
                    );
                  };
                ...
                { assert: 1, "./buffer_ieee754": 5, "base64-js": 7 },
              ],
              7: [
                function (require, module, exports) {
                  (function (exports) {
                    ...
                    function b64ToByteArray(b64) {
                      ...
                      placeHolders = b64.indexOf("=");
                      placeHolders =
                        placeHolders > 0 ? b64.length - placeHolders : 0;
      ...
      list should be an Array."
                  ...
                  function writeUInt16(
                    ...
                    if (isBigEndian) {
                      buffer.parent[buffer.offset + offset] =
                        (value & 0xff00) >>> 8;
                      buffer.parent[buffer.offset + offset + 1] =
                        value & 0x00ff;
                    } else {
                      buffer.parent[buffer.offset + offset + 1] =
                        (value & 0xff00) >>> 8;
                  ...
                  function writeUInt32(
                    ...
                    if (isBigEndian) {
                      ...
                      buffer.parent[buffer.offset + offset + 1] =
                        (value >>> 16) & 0xff;
                      buffer.parent[buffer.offset + offset + 2] =
                        (value >>> 8) & 0xff;
                      buffer.parent[buffer.offset + offset + 3] = value & 0xff;
                    } else {
                      buffer.parent[buffer.offset + offset + 3] =
                        (value >>> 24) & 0xff;
                      buffer.parent[buffer.offset + offset + 2] =
                        (value >>> 16) & 0xff;
                      buffer.parent[buffer.offset + offset + 1] =
                ...
                { assert: 1, "./buffer_ieee754": 8, "base64-js": 9 },
              ],
              9: [
                function (require, module, exports) {
                  (function (exports) {
